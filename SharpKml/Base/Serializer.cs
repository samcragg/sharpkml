    ...
    public class Serializer
    {
        ...
        private void SerializeElement(XmlWriter writer, XmlNamespaceManager manager, Element element)
        {
            if (WriteStartTag(writer, manager, element, out string ns))
            {
                ...
                this.SerializeElements(writer, manager, element.Orphans);
        ...
        private void SerializeElements(XmlWriter writer, XmlNamespaceManager manager, IEnumerable<Element> elements)
        {
            foreach (Element element in elements)
            {
                this.SerializeElement(writer, manager, element);
            }
        }
        ...
        private void WriteElements(XmlWriter writer, XmlNamespaceManager manager, Element element)
        {
            var browser = TypeBrowser.Create(element.GetType());
